...
public class GoldActivity extends Activity {
    ...
    private void render() {
        ...
        summary.setText("القيمة الحالية حسب بيع الموقع: " + money(total)
                + (cashoutTotal > 0 ? "\nقيمة البيع للتاجر حسب شراء الموقع: " + money(cashoutTotal) : "")
                + "\nإجمالي الوزن: " + String.format(Locale.US, "%.3f جرام", grams)
